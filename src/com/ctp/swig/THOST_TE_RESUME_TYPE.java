...
{
	public final static THOST_TE_RESUME_TYPE THOST_TERT_RESTART = new THOST_TE_RESUME_TYPE("THOST_TERT_RESTART",
			ctpJNI.THOST_TERT_RESTART_get());
	...
	{ THOST_TERT_RESTART, THOST_TERT_RESUME, THOST_TERT_QUICK };
