...
public class CThostFtdcMarginModelField {
	...
	public void setMarginModelID(String value) {
		CtpJNI.CThostFtdcMarginModelField_MarginModelID_set(swigCPtr, this,
				value);
	}

	public String getMarginModelID() {
		return CtpJNI.CThostFtdcMarginModelField_MarginModelID_get(swigCPtr,
				this);
	}

	public void setMarginModelName(String value) {
		CtpJNI.CThostFtdcMarginModelField_MarginModelName_set(swigCPtr, this,
				value);
	}

	public String getMarginModelName() {
		return CtpJNI.CThostFtdcMarginModelField_MarginModelName_get(swigCPtr,
				this);
	}
