...
public class CThostFtdcQryInstrumentStatusField {
	...
	public void setExchangeID(String value) {
		CtpJNI.CThostFtdcQryInstrumentStatusField_ExchangeID_set(swigCPtr,
				this, value);
	}

	public String getExchangeID() {
		return CtpJNI.CThostFtdcQryInstrumentStatusField_ExchangeID_get(
				swigCPtr, this);
	}

	public void setExchangeInstID(String value) {
		CtpJNI.CThostFtdcQryInstrumentStatusField_ExchangeInstID_set(swigCPtr,
				this, value);
	}

	public String getExchangeInstID() {
		return CtpJNI.CThostFtdcQryInstrumentStatusField_ExchangeInstID_get(
				swigCPtr, this);
	}
