...
public class CThostFtdcLoginForbiddenUserField {
	...
	public void setBrokerID(String value) {
		CtpJNI.CThostFtdcLoginForbiddenUserField_BrokerID_set(swigCPtr, this,
				value);
	}

	public String getBrokerID() {
		return CtpJNI.CThostFtdcLoginForbiddenUserField_BrokerID_get(swigCPtr,
				this);
	}

	public void setUserID(String value) {
		CtpJNI.CThostFtdcLoginForbiddenUserField_UserID_set(swigCPtr, this,
				value);
	}

	public String getUserID() {
		return CtpJNI.CThostFtdcLoginForbiddenUserField_UserID_get(swigCPtr,
				this);
	}
