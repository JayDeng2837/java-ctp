...
public class CThostFtdcQryErrOrderActionField {
	...
	public void setBrokerID(String value) {
		CtpJNI.CThostFtdcQryErrOrderActionField_BrokerID_set(swigCPtr, this,
				value);
	}

	public String getBrokerID() {
		return CtpJNI.CThostFtdcQryErrOrderActionField_BrokerID_get(swigCPtr,
				this);
	}

	public void setInvestorID(String value) {
		CtpJNI.CThostFtdcQryErrOrderActionField_InvestorID_set(swigCPtr, this,
				value);
	}

	public String getInvestorID() {
		return CtpJNI.CThostFtdcQryErrOrderActionField_InvestorID_get(swigCPtr,
				this);
	}
